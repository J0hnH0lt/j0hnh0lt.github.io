...
const F_FLOCKING = 10
const F_SWIRL = 11; // attract/repel by charge and inverse distance.
...
function CForcer() {
  ...
  this.bub_ctr = [0, 0, 0]; // bubble's center point position
  this.bub_force = 1.0; // inward-force's strength when outside the bubble
  this.bub_influence = 1.0;
  ...
  // F_SWIRL Single Spring variables;........................................
  this.swirlCntr = [0, 0, 0];
  this.swirlRad = 1;
  this.swirlStr = 2;

  // F_SWIRL Single Spring variables;........................................
  this.avoidance = 1; // k_a from book
  this.velMatching = 0.5; // k_v from book
  this.centering = 0.5; // k_c from book
  this.boidInf = 0.4; 
  this.personalSpace = 0.1; 
}
...
CForcer.prototype.printMe = function (opt_src) {
  ...
  if (tmp < 0) {
    console.log(
      "forceType ***NEGATED***; CForcer object temporarily disabled!"
    );
  ...
  switch (tmp) {
    ...
    case F_GRAV_P:
      ...
      console.log(
        "e1, e2 particle numbers:",
        this.e1,
        ", ",
        this.e2,
        "planetDiam (min e1,e2 distance):",
        this.planetDiam
      );
      break;
    case F_WIND:
      console.log("forceType: F_WIND. Stength: ", this.windStr, " Direction: ", this.windDir);
      break;
    case F_BUBBLE:
      console.log(
        "forceType: F_BUBBLE. bub_radius:",
        this.bub_radius,
        "bub_force:",
        this.bub_force
      );
      console.log("bub_ctr:", this.bub_ctr);
      console;
      break;
    case F_DRAG:
    ...
    case F_CHARGE:
      ...
      break;
    case F_FLOCKING:
      console.log("forceType: F_SWIRL. Avoidance Constant: ", this.avoidance,
                                     "Velocity Matching Const: ", this.velMatching,
                                     "Centering Constant: ", this.centering,
                                     "Range of Influence ", this.boidInf,
                                     "Personal Space: ", this.personalSpace);
      break;
    case F_SWIRL:
      console.log("forceType: F_SWIRL. Center: ", this.swirlCntr,
                                     "Stength: ", this.swirlStr,
                                      "Radius: ", this.swirlRad);
      break;
    default:
